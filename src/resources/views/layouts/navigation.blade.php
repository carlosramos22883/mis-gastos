    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
            <div class="flex">
                ...
                <!-- ============================================
     MENÚ: CONFIGURACIÓN DEL SISTEMA (Dropdown)
     Solo visible si el usuario tiene AL MENOS UN permiso de gestión
     ============================================ -->
                @canany(['users.view', 'users.create', 'users.edit', 'users.delete', 'roles.view', 'roles.create',
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <!-- Opción: Usuarios (Solo si tiene permisos de usuarios) -->
                                ...
                                <!-- Opción: Roles y Permisos (Solo si tiene permisos de roles) -->
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')"
                class="text-gray-800 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:text-white dark:bg-gray-800 dark:active:bg-gray-700">
                {{ __('Página de inicio') }}

<x-guest-layout>
    ...
    <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
        {{ __('¿Olvidaste tu contraseña? No hay problema. Solo necesitas proporcionarnos tu correo electrónico y te enviaremos un token para restablecer tu contraseña.') }}
    </div>
    ...
    <form method="POST" action="{{ route('password.email') }}">
        ...
        <div>
            ...
            <x-text-input id="email" class="block mt-1 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400" type="email" name="email" :value="old('email')" required autofocus />
